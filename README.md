...
You can re-run puppet and execute tests with `vagrant provision ROLE` repeatedly while the VM is up and running or `vagrant up jenkins::controller --provision
